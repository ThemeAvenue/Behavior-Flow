...
function bf_admin_scripts() {
	wp_register_script( 'bf-select2', BH_PATH . 'assets/js/vendor/select2.min.js', array( 'jquery' ), '3.5.2', true );
	wp_register_script( 'bf-main', BH_PATH . 'assets/js/behavior-flow.js', array( 'jquery' ), BF_VERSION, true );
...
function bf_admin_stylesheets() {
	wp_register_style( 'bf-main', BH_PATH . 'assets/css/behavior-flow.css', false, BF_VERSION, 'all' );
